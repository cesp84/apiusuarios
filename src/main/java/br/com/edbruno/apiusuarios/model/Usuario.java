...
// Gera automaticamente getId(), getNome() e getEmail().
@Getter

// Gera automaticamente setId(), setNome() e setEmail().
@Setter

// Gera automaticamente este construtor:
// public Usuario() {}
@NoArgsConstructor

// Gera automaticamente um construtor com id, nome e email.
@AllArgsConstructor
public class Usuario {
